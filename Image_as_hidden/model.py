...
class Complete(torch.nn.Module):
    def __init__(self, embed_size, total_words, num_hidden, num_layers):
        ...
        self.batch_norm = torch.nn.BatchNorm1d(
            num_hidden)  # for smoothness. Also 1d because its 3dim i screwed this up :C
    ...
    def forward(self, image, caption, length):
        ...
        #             print(caption)
        #             output, _ =\
        #                  torch.nn.utils.rnn.pad_packed_sequence(lstm_input, batch_first=True)
        #
        # so here's the funny thing. you apparently
        # put both image and caption in as inputs for training after
        # concatenation.
        # i don't get the math
        # this version doesn't do that though. we place image as hidden vector as input
    ...
    def caption(self, trigger, image,
        ...
        #  and then you put this in as the next input. yes. the word.
